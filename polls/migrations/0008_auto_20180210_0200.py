# -*- coding: utf-8 -*-
# Generated by Django 1.9 on 2018-02-10 02:00
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('nombre', models.CharField(blank=True, max_length=300, verbose_name='Estado Interprete')),
            ],
            options={
                'verbose_name': 'Color',
                'managed': True,
        ...
        migrations.AlterField(
            model_name='personal',
            name='color',
            field=models.ForeignKey(blank=True, max_length=300, null=True, on_delete=django.db.models.deletion.CASCADE, to='polls.Color'),
        ),
        migrations.AlterField(
            model_name='posicion',
            name='estado_maquina',
